...
import { Box, Button, chakra, HStack, Spinner, Tag, TagLabel, TagLeftIcon, Tooltip, Wrap } from "@chakra-ui/react";
    ...
    return (
        <>
            ...
            >
                ...
                {vonage.state.type === StateType.Connected ? (
                    <Button flexGrow={buttonsDirection === "row" ? 1 : 0} colorScheme="purple" onClick={onLeaveRoom}>
                        Leave Room
                    </Button>
                ) : (
                    <Tooltip
