...
export default function SystemConfiguration(): JSX.Element {
    ...
    const [insertM, insertResponse] = useInsertSysConfigPermissionGrantMutation();
    ...
    const [deleteM, deleteResponse] = useDeleteSysConfigPermissionGrantsMutation();
    ...
    return (
        <CRUDTable
            data={
                !allConfigurationsResponse.loading &&
